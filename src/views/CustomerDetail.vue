<template>
  <div class="customer">
    <header class="row w cus-head">
      ...
      <router-link :to="'/editCustomer/'+ this.userId + '/' + this.form.customerId" class="col v-m t-c cus-edit">编辑</router-link>
    </header>
    <main class="cus-main">
      <ul>
        <li class="row w">
        ...
        <li class="row w">
          <p class="col v-m t-l">城市</p>
          <p class="col v-m t-r">
            <input type="text" :value="data.areaFullName" disabled>
          </p>
        </li>
        <li class="row w">
          <p class="col v-m t-l">车牌号</p>
          <p class="col v-m t-r">
            <input type="text" :value="data.carNo" disabled>
          </p>
        </li>
        <li class="row w">
          <p class="col v-m t-l">车辆识别代号</p>
          <p class="col v-m t-r">
            <input type="text" :value="data.vin" disabled>
          </p>
        </li>
        <li class="row w">
          <p class="col v-m t-l">发动机号</p>
          <p class="col v-m t-r">
            <input type="text" :value="data.engine" disabled>
          </p>
        </li>
        <li class="row w">
          <p class="col v-m t-l">注册登记日期</p>
          <p class="col v-m t-r">
            <input type="text" :value="formatDate(data.registTime)" disabled>
          </p>
        </li>
        <li class="row w">
          <p class="col v-m t-l">保险到期日期</p>
          <p class="col v-m t-r">
            <input type="text" :value="formatDate(data.expireTime)" disabled>
          </p>
        </li>
        <li>
          <p class="note">备注</p>
          <p>
            <textarea type="text" :value="data.note" disabled></textarea>
          </p>
        </li>
      </ul>
    </main>
